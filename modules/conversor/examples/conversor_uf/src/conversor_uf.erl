%% conversor_uf.erl — BEAM bootstrap for ConversorUf.
%% Called by the iOS/Android native launcher via -eval 'conversor_uf:start().'.
...
start() ->
    ...
    step(5, fun() -> 'Elixir.ConversorUf.App':start() end),
