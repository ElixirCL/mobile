// build.zig — Android native build for conversor_uf.
//
...
//     Output: libconversor_uf.so installed to
//     android/app/src/main/jniLibs/<abi>/libconversor_uf.so so
