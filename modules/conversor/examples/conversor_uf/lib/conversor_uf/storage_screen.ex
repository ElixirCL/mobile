defmodule ConversorUf.StorageScreen do
  use Mob.Screen
  ...
  def handle_info({:tap, :write}, socket) do
    path = Path.join(Mob.Storage.dir(:documents), "conversor_uf_test.txt")
    case Mob.Storage.write(path, "ConversorUf storage test\n#{DateTime.utc_now()}") do
