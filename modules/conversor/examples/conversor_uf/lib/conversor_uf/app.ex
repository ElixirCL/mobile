defmodule ConversorUf.App do
  @moduledoc "Application entry point for ConversorUf."

  use Mob.App

  @impl Mob.App
  def navigation(_platform) do
    stack(:main, root: ConversorUf.HomeScreen)
  end
  ...
  def on_start do
    ...
    {:ok, _} = ConversorUf.Repo.start_link()
    Ecto.Migrator.with_repo(ConversorUf.Repo, fn repo ->
      Ecto.Migrator.run(repo, migrations_dir(), :up, all: true)
    end)

    Mob.Screen.start_root(ConversorUf.HomeScreen)
    Mob.Dist.ensure_started(node: :"conversor_uf_android@127.0.0.1", cookie: :mob_secret)
  end
  ...
  defp migrations_dir do
    case System.get_env("MOB_BEAMS_DIR") do
      nil       -> Application.app_dir(:conversor_uf, "priv/repo/migrations")
