defmodule ConversorUf.ListScreen do
  ...
  def handle_info(:reveal, socket) do
    ...
    ConversorUf.Repo.insert!(%ConversorUf.Round{
      user_choice:     user,
  ...
  defp load_rounds do
    ConversorUf.Repo.all(
      from r in ConversorUf.Round,
  ...
  defp history_row(%ConversorUf.Round{} = round) do
    {badge, color} =
